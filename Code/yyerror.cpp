...
void initErrorProcessing() {
    ...
    niceTokenNameMap["ERROR"] = (char *)"ERROR TOKEN";
...
{
    return (s != NULL && (strstr(s, "constant") != NULL || strstr(s, "identifier") != NULL));
}
